        ...
        {#if email}
          <div>
            ...
            <input
              ...
              class="w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-100 text-gray-600 cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <p class="mt-1 text-xs text-gray-500">
              You are resetting the password for this account.
            </p>
          </div>
        {:else}
