...
<div class="max-w-2xl">
	...
	<div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6 mb-6">
		...
		<form method="POST" use:enhance class="space-y-4">
			...
			<div>
				<label for="publicBio" class="block text-sm font-medium text-gray-700 mb-1"
					>Public bio (optional)</label
				>
				<textarea
					id="publicBio"
					name="publicBio"
				...
				<p class="mt-1 text-xs text-gray-500">
					Up to {data.publicBioMaxLength} characters. Leave blank to hide.
				</p>
			</div>
